    ...
    JSONLint.prototype = {
        ...
        object: function () {
            ...
            for (; ++self.i < self.length;) {
                ...
                else if (/[a-z0-9A-Z_]?/.test(self.c) || /[\"\']/.test(self.c)) {
                    coma = /[\"\']/.test(self.c) ? self.c : null;
                    empty = false;
                    if (self.key() === true) {
                        // Reset old endblock
                        self.endblock = _endblock;
        ...
        string: function (type) {
            ...
            for (; ++self.i < self.length;) {
                ...
                else if (coma && self.c == coma) {
                // else if (self.c == '"' || self.c == '\'') {
                    found = true;
                    coma == null;
                    break;
                }
                else if (type == "key" && (self.c == ":")) {
                    found = true;
                    self.i -= 1;
                    break;
                }
                else if (type == "key" && /[\"\']/.test(self.c)) {
                    found = true;
                    break;
                }
            }
