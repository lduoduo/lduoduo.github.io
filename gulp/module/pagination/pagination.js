...
(function (global, $) {
  ...
  $.fn[pluginName] = function (options) {
    ...
    var pagination = {
      ...
      initialize: function () {
        // if(attributes.totalNumber <= attributes.pageSize){
        //   return;
        // }
        var self = this;
      ...
      createTemplate: function (args) {
        ...
        if (args.totalNumber <= args.pageSize) {
          var html = args.totalNumber == 0 ? "没有任何记录" : "当前共" + args.totalNumber + "条记录";
          return "<div class='paginationjs-totalCount'>" + html + "</div>";
        }
        ...
        /** 总条数 */
        html += "<div class='paginationjs-totalCount'>共" + totalPage + "页" + totalNumber + "条</div>";
  ...
  function parameterChecker(args) {
    ...
    if (!args.dataSource) {
      args.dataSource = new Array(args.totalNumber - 0);
    }
